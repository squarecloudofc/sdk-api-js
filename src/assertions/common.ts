...
export function assertPathLike(value: unknown, code?: string): asserts value is string | Buffer {
  handleAssertion({ schema: pathLikeSchema, expect: "string or Buffer", value, code });
}
